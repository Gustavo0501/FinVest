...
class VisaoGeralView(TemplateView):
    ...
    def get(self, request):
        ...
        renda_atual = float(ultimo_registro.renda) if ultimo_registro else 0.0
        divida_atual = float(ultimo_registro.divida) if ultimo_registro else 0.0
        patrimonio_atual = float(ultimo_registro.patrimonio) if ultimo_registro else 0.0
