...
class TabelaViewsTest(TestCase):
    def setUp(self):
        ...
        self.tabela_global.acoes = [
            type('Acao', (object,), {"nome_ativo": "PETR4", "data": "2024-12-01", "abertura": 30.00, "maximo": 32.00, "minimo": 29.50, "fechamento": 31.50, "volume": 1000000})
        ]
        self.tabela_global.criptomoedas = [
            type('Criptomoeda', (object,), {"nome_ativo": "Bitcoin", "preco_atual": 50000.00, "capitalizacao_mercado": 900000000, "volume_24h": 50000000})
        ]
        self.tabela_global.save()
